    ...
    projects: [
      {
        ...
        stack: ['ReactJS', 'NextJS', 'TailwindCSS', 'Ant Design', 'Zustand', 'React Hook Form', 'Zod', 'Socket.io', 'Monaco Editor'],
        highlight: true,
      },
      {
        name: 'KingStudy',
    ...
    projects: [
      {
        ...
        stack: ['Socket.io', 'MongoDB', 'PostgreSQL', 'Redis', 'NextJS', 'TailwindCSS'],
        highlight: false,
      },
      {
        name: 'Happy Board',
        ...
        stack: ['Express.js', 'PostgreSQL', 'Sequelize', 'Redis', 'Elasticsearch', 'Firebase', 'RabbitMQ'],
        highlight: false,
      },
    ],
  },
...
export function ExperienceSection() {
  return (
    <section id="experience" className="bg-zinc-950 py-24 md:py-32">
              ...
              >
                ...
                <div className="flex flex-col sm:flex-row sm:items-baseline sm:justify-between gap-1 mb-7">
                  <div>
                    ...
                    <p className="text-sm font-mono text-zinc-500 mt-0.5">{exp.role}</p>
                  </div>
                  <span
                      ...
                      <ul className="space-y-1.5 mb-3">
                        {proj.highlights.map((h, hi) => (
                          <li key={hi} className="flex gap-2 text-sm">
                            ...
                            <span
                              className={
                                proj.highlight && hi === proj.highlights.length - 1
